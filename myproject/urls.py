...
from numeter import views as numeter_views

urlpatterns = [
	path('', views.home, name='home'),
    path('numeter/', numeter_views.numeter, name='numeter'),
    #path('numeter/', auth_views.LoginView.as_view(template_name='numeter.html'), name='numeter'),
